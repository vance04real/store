...
public class CustomerServiceImpl implements CustomerService {
    ...
    public Page<CustomerDTO> getAllCustomers(Pageable pageable) {
        log.info(
                "Fetching customers page {} with size {} (cache miss)",
    ...
    @Override
    @CacheEvict(
            value = {CacheConfig.CUSTOMERS_CACHE, CacheConfig.CUSTOMER_SEARCH_CACHE},
            allEntries = true)
    public CustomerDTO createCustomer(CustomerDTO customerDTO) {
        ...
        log.info(
                "Customer created successfully - ID: {}, Name: {} {}",
                savedCustomer.getId(),
        ...
        return customerRepository
                ...
                .orElseThrow(() -> {
                    String msg = messageSource.getMessage(
                            MessageKeys.CUSTOMER.NOT_FOUND, new Object[] {id}, LocaleContextHolder.getLocale());
    ...
    @Override
    @Cacheable(
            value = CacheConfig.CUSTOMER_SEARCH_CACHE,
            key = "#searchTerm + '-' + #pageable.pageNumber + '-' + #pageable.pageSize")
    public Page<CustomerDTO> searchCustomers(String searchTerm, Pageable pageable) {
        ...
        if (searchTerm == null || searchTerm.trim().isEmpty()) {
            String msg = messageSource.getMessage(
                    MessageKeys.CUSTOMER.SEARCH_TERM_EMPTY, null, LocaleContextHolder.getLocale());
    ...
    private void validateCustomerCreation(CustomerDTO customerDTO) {
        ...
        if (customerDTO.getFirstName() == null
            ...
            String msg = messageSource.getMessage(
                    MessageKeys.CUSTOMER.FIRST_NAME_REQUIRED, null, LocaleContextHolder.getLocale());
            throw new IllegalArgumentException(msg);
        }
        ...
        if (customerDTO.getLastName() == null
            ...
            String msg = messageSource.getMessage(
                    MessageKeys.CUSTOMER.LAST_NAME_REQUIRED, null, LocaleContextHolder.getLocale());
            throw new IllegalArgumentException(msg);
        }

        log.info("Customer validation passed - Name: {} {}", customerDTO.getFirstName(), customerDTO.getLastName());
    }
}
